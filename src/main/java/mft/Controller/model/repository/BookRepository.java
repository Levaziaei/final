...
public class BookRepository implements AutoCloseable {
    ...
    public Book edit(Book book) throws Exception {
        connection = JdbcProvider.getJdbcProvider().getConnection();
        preparedStatement = connection.prepareStatement(
                "UPDATE BORROW_TBL SET NAMEBOOK=?, AUTHORBOOK=?, NAMEANDFAMILY=? ,YOURSUGGESTION=? WHERE ID=?"
        );
        ...
        while (resultSet.next()) {
            Book book =
                    Book
                            ...
                            .author(resultSet.getString("author is"))
        ...
        while (resultSet.next()) {
            book =
                    Book
                            ...
                            .author(resultSet.getString("author Book"))
